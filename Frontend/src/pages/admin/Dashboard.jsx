...
const Dashboard = () => {
    ...
    return (
        <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <Link to="/dashboard/manage-books" className="flex items-center p-8 bg-white shadow rounded-lg hover:shadow-lg transition-shadow duration-300">
            ...
            {/* Total Sales Card (No link needed as per your request) */}
            ...
            {/* Total Orders Card with Link */}
            <Link to="manage-orders" className="flex items-center p-8 bg-white shadow rounded-lg hover:shadow-lg transition-shadow duration-300">
